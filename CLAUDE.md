...
Never `git commit`, `push`, or merge a branch unless the user explicitly asks for
it in that turn. Finishing or verifying a milestone/feature is not itself
permission — wait to be told.
